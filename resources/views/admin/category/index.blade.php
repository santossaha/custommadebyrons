            ...
            <div class="row mt">
                <div class="col-lg-12">
                    <div class="content-panel">
                        <h4><i class="fa fa-angle-right"></i> Category List <a class="btn btn-xs btn btn-success ajax_fancybox fancybox.iframe" href="{{route('admin::add_category')}}"><i class="fa fa-plus"></i> Add New</a></h4>
                        <section id="unseen">
        ...
        <script>
            $(document).ready( function () {
                ...
                $('#Datatable').DataTable({
                    ...
                    serverSide: true,
                    ajax: {
                        url: '{{route('admin::manage_category')}}',
                        type: 'GET'
                    },
                    columns: [
