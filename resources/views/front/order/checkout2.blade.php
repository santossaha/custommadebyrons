...
<!-- contact area -->
  <form method="post" action="{{route('checkout_processs')}}" id="chechk_out_form">
  {{csrf_field()}}
                        ...
                        <ul class="list-group list-group-flush">
                            ...
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                ...
                                <span>
                                    ...
                                    @else
                                    <ul class="list-group list-group-flush">No product here</ul>
                                    @endif
                                    ...
                                    <ul class="list-group list-group-flush">
                                        ...
                                        <li class="list-group-item d-flex justify-content-between align-items-center">
                                            <div class="custom-control coustom-checkbox">
                                                <input type="radio" class="custom-control-input" id="customCheck5" name="payment_mode" value="1">
                                ...
                                <div id="stripe_from" style="display: none;" class="card-wrapper">
                         <label for="card_name" class="control-label mb-1">Full Name <span class="span-req">*</span>:</label>
                                      <input class="form-control error" id="card_name" name="card_name" type="text" aria-invalid="true"><label id="card_name-error" class="error" for="card_name">Please enter card holder name</label>
                              <label for="card_number" class="control-label mb-1">Card Number <span class="span-req">*</span>:</label>
                              <input class="form-control jp-card-invalid visa identified valid" id="card_number" data-inputmask="'mask': '9999 9999 9999 9999'" name="card_number" type="text" aria-invalid="false">
                            
                                     
                                   
                                  
                                      <label for="card_code" class="control-label mb-1">CVV <span class="span-req">*</span>:</label>
                                      <input class="form-control jp-card-valid valid" id="card_code" name="card_code" type="text" aria-invalid="false">
                                    
                                      <label for="expiry" class="control-label mb-1">Expiry Month<span class="span-req">*</span>:</label>
                                      <input class="form-control error" id="expiry" name="expiry" type="text"><label id="expiry-error" class="error" for="expiry">Please enter expire month</label>
                                       <label for="expiry" class="control-label mb-1">Expiry Year<span class="span-req">*</span>:</label>
                                     
                                   
                </div>
                                <button type="submit" class="btn btn-transparent btn-rounded btn-large mt-5 order_submit" style="display: none;">Place Order</button>
 	...
 	$(document).ready(function(){
        $('input:radio[name=payment_mode]').change(function() {
              var checked = $('input[name=payment_mode]:checked').val();
                ...
                if(checked=='2'){
                     $("#stripe_from").css("display", "block");
                 }else{
                     $("#stripe_from").css("display", "none"); 
                 }
        });
 		$.ajaxSetup({
            headers: {
        ...
        new Card({
        form: document.querySelector('form#chechk_out_form'),
...
$(document).ready(function() {
    $('body').on('click','.order_submit',function(){
        // if ($('#same_billing_shipping').is(":checked")){
