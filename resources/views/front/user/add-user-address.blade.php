...
<section id="banner" class="inner-backg">
    ...
    <section class="user-dashboard">
        ...
        <div class="col-md-12">
            ...
            <div>
                {{ Form::open(['route' => 'add_address', 'method' => 'post', 'id' => 'user_address_form']) }}
                    <div class="row">
                      ...
                      <div class="col-md-12 user-profile">
                            ...
                            <input type="checkbox" class="form-control" id="default_address" name="default_address" value="1">
                      </div>
                      <div class="col-md-6">
                          <button type="submit" class="btn btn-primary submit-btm">Save Address</button>
                      </div>
